...
window.SmoothScroll=SmoothScroll;})();(function($){"use strict";jQuery(window).on('load',function(){(function($){if(typeof SmoothScroll=='function'&&$('body').hasClass('luxescroll')){SmoothScroll({keyboardSupport:false});}})(jQuery);});})(jQuery);